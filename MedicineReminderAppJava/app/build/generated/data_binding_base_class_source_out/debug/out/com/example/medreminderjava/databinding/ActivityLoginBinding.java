...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull MaterialButton btnLogin,
      @NonNull TextInputEditText etMobile, @NonNull TextInputEditText etPassword,
      @NonNull ImageView ivLogo, @NonNull TextInputLayout tilMobile,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, btnLogin, etMobile, etPassword,
          ivLogo, tilMobile, tilPassword, tvRegisterLink, tvSubtitle, tvTitle);
    }
